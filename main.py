...
class Iwindow(QtWidgets.QMainWindow, gui):
    ...
    def draw_segmentation_map(self, image, masks, boxes, labels):
        alpha = 1
        beta = 0.2 # transparency for the segmentation map
        gamma = 2 # scalar added to each sum
        class_colors = {"crop": (255, 0, 0), "weed": (0, 255, 0), 'johnson grass': (255, 0, 0), 'purslane': (0, 255, 0), 'field bindweed': (155, 100, 100)}
